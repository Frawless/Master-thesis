...
Response time as issue was already mentioned in Subsection \ref{Response Time 1}; response time as metric is consist of two parts which are \emph{latency} and \emph{service time}. \todo{Smysluplne dopsat ?}
