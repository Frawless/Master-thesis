...
\begin{itemize}
	\setlength\itemsep{0em}
	\item Inspector sent an HTTP request with the JSON \footnote{JSON - JavaScript Object Notation \url{https://www.json.org/}} content to the Broker REST interface.
