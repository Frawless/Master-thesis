...
plot "soak_testing.dat" using 1:2 ls 2 title 'Load Size' with filledcurves x1 axes x1y1,\
     "soak_testing.dat" using 1:3 ls 1 title 'Memory Active' with filledcurves x1 axes x1y2 fs transparent
