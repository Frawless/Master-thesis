...
set style line 2 lt 2 lc rgb "#60BD68" lw 4 pt 7 ps 0.8
...
plot "load_testing.dat" using 1:3 ls 2 title 'Request number' with filledcurves x1 axes x1y1,\
     "load_testing.dat" using 1:2 ls 1 title 'Load Size' with filledcurves x1 axes x1y2
