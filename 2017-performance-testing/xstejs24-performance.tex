...
\keywords[cs]{Testování, analýza výkonu, testování výkonu, síťové technologie, router, Qpid-Dispatch}
\keywords[en]{Testing, performance analysis, performance testing, network technologies, router, Qpid-Dispatch}
...
\fi
  ...
  \iftwoside
    \cleardoublepage
  \fi
  \input{xstejs24-performance-30-prilohy-appendices} % viz. prilohy.tex / see prilohy.tex
\end{document}
