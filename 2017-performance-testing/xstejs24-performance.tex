...
\projectinfo{
  ...
  supervisor.title.a={Ing.},    %titul za jmenem (nepovinne) / title after the name (optional)
...
\declaration{Prohlašuji, že jsem tuto diplomovou práci vypracoval samostatně pod vedením pana Ing. Zdeňka Krause a pana Ing. Tomáše Fiedora.
Další informace mi poskytli...
Uvedl jsem všechny literární prameny a publikace, ze kterých jsem čerpal. \todo{Doplnit}}
